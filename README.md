...
Este proyecto nació como continuación de una landing page estática, con el objetivo de aplicar JavaScript a un negocio real (servicio técnico de refrigeración) y de aprender el proceso completo de llevar un sitio a producción: SEO básico y deploy en Netlify.
